...
| -- | --------- | ------------- | -------------- | ----------------- | --------------- | --------------- |
| 1  | Ver 1.0   | 2026-08-20    | Tạo mới        | Khởi tạo Business Case: nhu cầu, phân tích phương án, chi phí – lợi ích, phân tích tài chính, đánh giá khả thi, khuyến nghị | `<<Họ và tên>>` | `<<Họ và tên>>` |
| 2  | Ver 1.1   | 2026-08-20    | Chỉnh sửa      | Thay mô hình doanh thu: bỏ thuê bao khoá tính năng (không thực thi được với sản phẩm mã nguồn mở chạy client-side), chuyển sang bán gói template và dịch vụ B2B. Quy mô đội 5 → 3 người. Bỏ giới hạn 2 phút, chuyển sang mã hoá theo luồng. Tính lại toàn bộ chi phí và dòng tiền trên cơ sở vốn tiền mặt gần bằng 0 | `<<Họ và tên>>` | `<<Họ và tên>>` |
