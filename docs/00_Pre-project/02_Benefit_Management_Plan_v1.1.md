...
| 2  | Ver 1.1   | 2026-08-20    | Chỉnh sửa      | Cập nhật theo mô hình doanh thu M2: tách 3 dòng doanh thu, bỏ lợi ích từ thuê bao. Thêm lợi ích "không giới hạn độ dài video". Cập nhật quy mô đội 5 → 3 người và ngưỡng hoà vốn 62% → 48% | `<<Họ và tên>>` | `<<Họ và tên>>` |
...
[Business Case](./01_Business_Case_v1.1.md) là nguồn gốc của các con số lợi ích. [Project Charter](../01_Initiating/01_Project_Charter_v1.1.md) chứa các mục tiêu đo được mà dự án phải đạt để lợi ích có cơ hội xảy ra. Mọi giả định nêu ở đây đều có ID tương ứng trong [Assumption Log](../01_Initiating/02_Assumption_Log_v1.1.md).
...
Đội chỉ có 3 thành viên nên **một người kiêm nhiều vai trò**. Bảng dưới phân theo vai trò, không phải theo người; việc ánh xạ vai trò sang người cụ thể ghi tại [Project Charter §9](../01_Initiating/01_Project_Charter_v1.1.md#9-stakeholder-list).

| Vai trò                | Người đảm nhiệm  | Trách nhiệm về lợi ích |
| ---------------------- | ---------------- | ---------------------- |
| Nhà tài trợ (Sponsor)  | `<<Họ và tên>>` — Enticy Studios | Chịu trách nhiệm cuối cùng về BN-01 → BN-04 và BN-12. Ra quyết định khi lợi ích chệch mục tiêu. |
| Giám đốc dự án (PM)    | `<<Họ và tên>>`  | Chịu trách nhiệm BN-11 và việc bàn giao danh mục lợi ích khi đóng dự án. |
| Trưởng nhóm kỹ thuật   | `<<Họ và tên>>`  | Chịu trách nhiệm BN-07, BN-08, BN-09, BN-10 trong thời gian dự án. |
| Trưởng nhóm sản phẩm   | `<<Họ và tên>>`  | Chịu trách nhiệm BN-05, BN-06. Thu thập phản hồi người dùng. |
...
Chi tiết đầy đủ tại [Assumption Log](../01_Initiating/02_Assumption_Log_v1.1.md).
...
| 🔴 Chệch ≥ 20% | Báo cáo nhà tài trợ trong vòng 5 ngày làm việc; xem xét lại giả định gốc trong [Assumption Log](../01_Initiating/02_Assumption_Log_v1.1.md); nếu lệch hai kỳ liên tiếp, đưa ra quyết định về số phận sản phẩm |
...
*Tài liệu liên quan: [Business Case](./01_Business_Case_v1.1.md) · [Project Charter](../01_Initiating/01_Project_Charter_v1.1.md) · [Assumption Log](../01_Initiating/02_Assumption_Log_v1.1.md)*
