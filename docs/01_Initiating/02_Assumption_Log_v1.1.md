...
| AS-20 | Nội dung và hình ảnh do người dùng đưa vào là hợp pháp và thuộc quyền của họ | 2026-08-20 | Nhà tài trợ | M6 (2026-11-29) | 🔵 Mở | Rủi ro liên đới về bản quyền nếu sản phẩm bị coi là trung gian | Điều khoản sử dụng nêu rõ trách nhiệm thuộc người dùng; sản phẩm không lưu trữ, không phân phối nội dung |
...
| 5 | AS-11 | M2 — 2026-09-27 | Không có quyền phân phối lại tài sản đồ hoạ thì **không bán được gói template** — dòng doanh thu chính không tồn tại. |
| 6 | AS-09 | M0 — 2026-08-30 | Sai lịch học kỳ thì mọi mốc M0–M7 phải lập lại. |
| 7 | AS-15 | M2 — 2026-09-27 | Không có muxer theo luồng dùng được thì phát sinh 3–4 tuần không có trong 450 giờ. |
| 8 | AS-01 | M1 — 2026-09-13 | Không đo baseline trước khi phát triển thì lợi ích BN-06 vĩnh viễn không chứng minh được. |
| 9 | AS-24 | M0 — 2026-08-30 | Mùa thi rơi vào đường găng là rủi ro tiến độ lớn nhất mà đội kiểm soát được. |

**Năm trong chín giả định gấp nhất đều đến hạn tại M2.** Đây là lý do M2 được thiết kế thành mốc quyết định: nếu nguyên mẫu không đạt, còn 10 tuần để đổi hướng — muộn hơn thì không kịp.
